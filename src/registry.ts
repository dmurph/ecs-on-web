...
export const SIMULATOR_REGISTRY: SimulatorConfig[] = [
  ...
  },
  {
    ...
    color: '#c2410c',
    activeByDefault: true,
    sourceFile: 'benchmark_oop_tree.ts',
  ...
  },
  {
    ...
    color: '#0f766e',
    activeByDefault: true,
    sourceFile: 'benchmark_custom_ecs.ts',
  ...
  },
  {
    ...
    color: '#b45309',
    activeByDefault: true,
    sourceFile: 'benchmark_ecs_tree.ts',
  ...
  },
  {
    ...
    color: '#0284c7',
    activeByDefault: true,
    sourceFile: 'benchmark_bitecs.ts',
